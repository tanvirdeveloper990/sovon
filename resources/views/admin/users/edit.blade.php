    ...
    <div class="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <form method="POST" 
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-gray-700 font-medium mb-1">
                        Confirm Password <span class="text-gray-400 text-sm">(Optional)</span>
                    </label>
            ...
            <div class="flex justify-end pt-4 border-t">
                <button type="submit" 
                        class="bg-cyan-600 hover:bg-cyan-700 text-white px-6 py-2 rounded-lg transition-all duration-200 flex items-center gap-2">
