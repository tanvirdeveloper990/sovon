...
<section class="p-5 bg-gray-100 min-h-screen">
    <div class="mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <!-- Form Body -->
        <div class="p-8">
            <form method="POST" action="{{ route('admin.brands.update', $data->id) }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @if($data->image)
                            <img src="{{ Storage::url($data->image) }}" alt="Brand Image" class="w-20 h-20 mt-3 rounded-lg shadow">
                        @endif
                    </div>
