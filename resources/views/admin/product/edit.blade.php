...
<section class="p-5 bg-gray-100 min-h-screen">
    <div class="mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <!-- Form Body -->
        <div class="p-8">
            <form method="POST" action="{{ route('admin.products.update', $data->id) }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $data->name) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:border-cyan-500 focus:ring-0 outline-none" placeholder="Enter product name" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="review" value="{{ old('review', $data->review) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:border-cyan-500 focus:ring-0 outline-none" placeholder="Enter review">
                    </div>

                    <!-- Product Text -->
                    <div>
                        <label class="block text-gray-700 font-medium mb-1">Product Text</label>
                        <input type="text" name="product_text" value="{{ old('product_text', $data->product_text) }}"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:border-cyan-500 focus:ring-0 outline-none" placeholder="Enter product text">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="product_text_description" rows="4"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:border-cyan-500 focus:ring-0 outline-none" placeholder="Enter product description">{{ old('product_text_description', $data->product_text_description) }}</textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="4"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:border-cyan-500 focus:ring-0 outline-none" placeholder="Enter description">{{ old('description', $data->description) }}</textarea>
                    </div>
