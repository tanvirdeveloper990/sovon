    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-cyan-600 px-6 py-4 text-white">
                <h3 class="text-xl font-semibold tracking-wide">SubCategory List</h3>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-5 py-3 text-center">
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    <a href="{{ route('admin.subcategories.edit', $item->id) }}"
                                    ...
                                    <form id="delete-form-{{ $item->id }}"
                                        action="{{ route('admin.subcategories.destroy', $item->id) }}" method="POST"
                                        class="hidden">
                                        @csrf
                                        @method('DELETE')
                                    </form>
